...
Este comportamiento confirma que el impacto social no es un fenómeno aislado, sino una condición presente de forma transversal en la experiencia del sistema. El uso de esta métrica permite evidenciar estas situaciones con mayor claridad que un promedio simple, el cual tiende a mostrar una percepción general neutral o moderada.
...
En términos prácticos, este análisis permite responder: ¿qué componentes del servicio se mueven juntos y cuáles son los que más explican la percepción general del sistema?
...
Perfecto. Aquí te dejo **una propuesta sencilla, de valor y muy defendible**, pensada exactamente para responder esa pregunta sin sobrecomplicarla.
La puedes **pegar tal cual** en el informe.
...
Finalmente, los temas identificados en el análisis textual se contrastan con los resultados del análisis descriptivo y multidimensional. De esta forma, las respuestas abiertas se utilizan como un **insumo explicativo**, que ayuda a entender por qué ciertos atributos del servicio presentan mayores niveles de insatisfacción o impacto social negativo.
...
A partir del uso combinado de técnicas estadísticas descriptivas, análisis multidimensional y exploración de texto, se logró construir un diagnóstico integral sobre la satisfacción de los usuarios del sistema y los factores que influyen en su percepción del servicio. Este enfoque permitió ir más allá de promedios generales y evidenciar tanto la intensidad del impacto social como las dimensiones específicas que lo explican.
...
El análisis multidimensional evidenció que las mayores afectaciones no se concentran en una sola dimensión, sino que se distribuyen principalmente en **información**, **entorno de uso** y **condiciones operativas**, especialmente en situaciones de alta demanda. Estas dimensiones explican buena parte del impacto social negativo identificado y muestran que la insatisfacción no responde únicamente a fallas aisladas, sino a la combinación de varios componentes del servicio.
...
En conclusión, el uso articulado de análisis estadísticos y exploración cualitativa permitió identificar no solo el nivel de satisfacción del usuario, sino también los componentes del servicio que más inciden en su experiencia. Este enfoque integral ofrece una base sólida y accionable para la toma de decisiones orientadas al mejoramiento continuo del sistema y al fortalecimiento de la percepción positiva por parte de sus usuarios.
